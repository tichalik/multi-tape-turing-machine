...
public class TuringMachine {
     ...
     * @return blank symbol of the machine
     */
    ...
    /**
     * exports the transitions as a list of strings
     * @return list of separate transitions
     */
    public ArrayList<String> getTransitionsStrings(){
